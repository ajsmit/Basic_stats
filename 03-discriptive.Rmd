...
```{r rmarkdown, echo = FALSE, fig.margin = TRUE, fig.cap = "The proportions of data representation by the standard deviation. Credit: [Wikipedia](https://en.wikipedia.org/wiki/Standard_deviation)"}
