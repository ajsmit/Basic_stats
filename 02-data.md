...
\begin{figure}
\includegraphics[width=27.69in]{figures/chicks_1} \caption{What is in the Chicks data?}(\#fig:chicks_1)
\end{figure}

\begin{figure}
\includegraphics[width=27.69in]{figures/chicks_2} \caption{This is what is in the Chicks data}(\#fig:chicks_2)
\end{figure}
