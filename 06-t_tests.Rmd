...
$$S^{2}=\frac{\sum_{i=1}^{n}{(x_{i}-\bar{A})^{2}}+\sum_{i=1}^{n}{(x_{i}-\bar{B})^{2}}}{n_{A}+n_{B}-2}$$
...
$$d.f. = \frac{\left( \frac{S^{2}_{A}}{n_{A}}+\frac{S^{2}_{B}}{n_{B}} \right)^{2}}{\left( \frac{S^{4}_{A}}{n^{2}_{A}(n_{A}-1)} + \frac{S^{4}_{B}}{n^{2}_{B}(n_{B}-1)} \right)}$$
