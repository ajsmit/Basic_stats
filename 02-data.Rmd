...
#### Dates
Dates are a special class of continuous data, and there are many different representational of the date classes. This is a complex group of data, and we will not cover much of it here.
...
This will serve well as an introduction to the next chapter, which is about the descriptive statistics. What are they, and how do we calculate them?
